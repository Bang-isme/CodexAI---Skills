...
4. Plan implementation tasks and acceptance criteria. Substantial UI needs a design contract first; backend-only and tiny CSS fixes do not.
5. Execute implementation in small, verifiable increments.
6. Run `pre_commit_check.py` and `smart_test_selector.py` before finalizing. UI changes also run mechanical visual evidence.
