...
```json
{"status": "built", "schema_version": "2.0", "artifact_type": "knowledge-build-payload", "generated_at": "<iso8601>", "project_root": "<path>", "index_path": "<file>", "markdown_path": "<file>", "graph_path": "<file>", "html_path": "<file>", "stats": {<object>}, "warnings": [<string>], "redaction": {<object>}, "sources": {<object>}, "graph_stats": {<object>}}
```
