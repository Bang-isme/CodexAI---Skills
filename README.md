...
- `ci.yml`: plugin validators, pack health, tool contracts, prompt-router corpus, memory-at-scale (medium synthetic gate), Linux/Windows pytest, project-memory smoke, and GitHub CLI contract checks.
